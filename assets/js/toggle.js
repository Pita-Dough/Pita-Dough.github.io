    ...
    toggleButtons.forEach(function(button, index) {
        button.addEventListener("click", function() {
            ...
            if (toggleBlocks[index].style.maxHeight){
                ...
                button.innerHTML = "Abstract <i class='btn btn-sm z-depth-0' role='button' target='_blank' style='font-size:12px;border:1px solid black'><i class='fas fa-chevron-down' style='font-size:12px'></i>"; // this − minus sign is of equal length as +  
              } else {
                toggleBlocks[index].style.maxHeight = toggleBlocks[index].scrollHeight + "px";
                button.innerHTML = "Abstract <i class='btn btn-sm z-depth-0' role='button' target='_blank' style='font-size:12px;border:1px solid black'><i class='fas fa-chevron-up' style='font-size:12px'></i>"; 
              }
